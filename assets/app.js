...
//      }
      ...
      function doGameEnd(outcome) {
        ...
        if ('won' === outcome) {
          html = '<p>Szuper vagy, így tovább! <button id="hangman-reset-game">Tovább a következő játékra!</button></p>';
        }
        else {
          html = '<p>Nézzük a következőt! <button id="hangman-reset-game">Próbáld meg újra!</button></p>';
        }
